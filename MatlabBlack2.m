...
sol.lblue   = [ 99 184 255] / 256;

%% Setup Color Scheme for Light/Dark Options
    sycb = 0;           % Set 'Use system colors' checkbox to False
    txc  = sol.white;   % Set 'Text' color
    bgc  = sol.base03;  % Set 'Background' color
    kwd  = sol.lblue;  % Set 'Keywords' color
    cmt  = sol.green;   % Set 'Comments' color - spec calls for base1, not sure about that...
